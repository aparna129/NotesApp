...
function Notes() {
  ...
  useEffect(() => {
    ...
    if (storedGroups const newVisibility = Array(groups.length).fill(false); // Create an array of false values of the same length as groups

    // Set the clicked group's visibility to true
